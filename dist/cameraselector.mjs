...
var ja$1 = {
	...
	"cameraselector.entry.description": "使用するカメラを切り替えられるようにします。"
};
var translations$1 = {
	en: en$1,
	ja: ja$1,
	...
	"cameraselector.entry.description": "つかうかめらをえらべるようにします。"
}
};
...
var entry = {
  get name() {
    return formatMessage$1({
      ...
      default: translations$1.en['cameraselector.entry.name'],
  ...
  get description() {
    return formatMessage$1({
      defaultMessage: translations$1.en['cameraselector.entry.description'],
...
var ExtensionBlocks = /*#__PURE__*/function () {
  ...
  _createClass(ExtensionBlocks, [{
    ...
    key: "selectCameraWithLabel",
    value: function selectCameraWithLabel(args) {
